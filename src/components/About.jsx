...
const About = () => {
  ...
  return (
    <section ref={aboutRef} className="py-20 px-6 bg-gray-50 dark:bg-gray-800">
          ...
          >
            ...
            <div className="prose prose-lg text-gray-600 dark:text-gray-300 mb-8">
              ...
              <p>
                ...
                at
                <strong> PT Greatedu Global</strong> and crafted a mental health
                app at
                <strong> Binar Academy</strong>, taking each project from user
