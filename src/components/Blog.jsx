      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Sharing thoughts on design, user experience, and digital innovation
            exploring the creative process, what makes a product compelling, and
            how technology and design are shaping the future.
          </p>
        </div>
