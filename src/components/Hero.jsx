  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Headline */}
        <h1
          className={`text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-8 leading-tight transition-all duration-1000 delay-400 ${
        ...
        >
          ...
          <a
            href="/Professional-Resume2.pdf"
            download="Professional-Resume Samsul Aimah.pdf"
